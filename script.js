...
function renderAuctionControls(){
  ...
  if(ff){ff.style.display=canControlSpeed?'inline-flex':'none';ff.textContent=auctionSpeed===1?'⏩ FAST FORWARD':`⏩ ${auctionSpeed}× FAST FORWARD`;ff.title='Click to cycle 1× → 2× → 4× → 6×';}
  if(select){
